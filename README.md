...
- простое использование в тексте заметки плэйсхолдера типа @{{/page/note}} - позволяет читать, вызывать, вставлять различные вызовы и интеграции с другими заметками
...
- Charts View
- Log Analyzer View 
- Spring Actuator View ( Experimental )
