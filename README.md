...
- Jira Task View - 
- Simple HTML View - view.zznote.ru/html
- XSD Validator View - view.zznote.ru/xsd
- JSON path analyze View - view.zznote.ru/json
- Charts View 
- Log Analyzer View zznote.ru/@@logs
- Spring Actuator View zznote.ru/@@actuator
- Docker API View  - zznote.ru/@@docker
