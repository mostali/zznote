# sudo docker build -t cr-image:1 -f Rocky.Dockerfile . && sudo docker run  cr-image:1
#  docker save skpy:1 | bzip2 | ssh user@host docker load
...
#simple run
#cd /home/dav/pjm/otr/otr-atb/Dockerfiles-Examples/consol && sudo docker build -t cr-image:1 -f Rocky.Dockerfile . && sudo docker run  cr-image:1

#full run with build jar
#BEA_ && d --pack && cp ./target/bea.jar /home/dav/pjm/otr/otr-atb/Dockerfiles-Examples/consol/app.jar && cd /home/dav/pjm/otr/otr-atb/Dockerfiles-Examples/consol && sudo docker build -t cr-image:1 -f Rocky.Dockerfile . && sudo docker run  cr-image:1

# sudo docker build -t cr-image:1 -f Dockerfile . && sudo docker run  cr-image:1

#
#comment this line for run docker container as Desktop application
#
